...
.mode0:
		...
		move.l	#CmdTaskMd_CameraPos,d0		; Reset camera
		moveq	#0,d1
		moveq	#0,d2
		moveq	#0,d3
		moveq	#0,d4
		...
		move.l	#CmdTaskMd_MapSet,d0		; Set layout map to 0 (No map data)
		moveq	#0,d1
		bsr	System_MdMars_AddTask
		...
		bsr	System_MdMars_AddTask
		move.l	#CmdTaskMd_ObjectPos,d0		; And it's position/rotation
		moveq	#0,d1
		moveq	#0,d2
		moveq	#0,d3
		move.l	#-$30000,d4
		...
		move.w	#$7FFF,d5
		bsr	System_MdMars_AddTask
.holdon_0:	bsr	System_MdMars_CheckBusy
		bne.s	.holdon_0
...
.holdon_p0:	bsr	System_MdMars_CheckBusy
		bne.s	.holdon_p0
		moveq	#0,d1
		move.l	#PWM_LEFT,d2
...
.holdon_p:	bsr	System_MdMars_CheckBusy
		bne.s	.holdon_p
		bsr	System_MdMars_SendAll
